<p align="center"><a href="https://nodei.co/npm/telegraf-xp/"><img src="https://nodei.co/npm/telegraf-xp.png"></a></p>
...
```js
/* xpFor Example */
const Levels = require("telegraf-xp");
...
```js
Levels.createUser(<UserID - String>, <chatID - String>);
```
- Output:
```
Promise<Object>
...
```js
Levels.deleteUser(<UserID - String>, <chatID - String>);
```
- Output:
```
Promise<Object>
...
```js
Levels.appendXp(<UserID - String>, <chatID - String>, <Amount - Integer>);
```
- Output:
```
Promise<Boolean>
...
```js
Levels.appendLevel(<UserID - String>, <chatID - String>, <Amount - Integer>);
```
- Output:
```
...
```js
Levels.setXp(<UserID - String>, <chatID - String>, <Amount - Integer>);
```
- Output:
```
Promise<Boolean/Object>
...
```js
Levels.setLevel(<UserID - String>, <chatID - String>, <Amount - Integer>);
```
- Output:
```
Promise<Boolean/Object>
...
```js
Levels.fetch(<UserID - String>, <chatID - String>, <FetchPosition - Boolean>);
```
- Output:
```
Promise<Object>
...
```js
Levels.subtractXp(<UserID - String>, <chatID - String>, <Amount - Integer>);
```
- Output:
```
Promise<Boolean/Object>
...
```js
Levels.subtractLevel(<UserID - String>, <chatID - String>, <Amount - Number>);
```
- Output:
```
Promise<Boolean/Object>
...
```js
Levels.fetchLeaderboard(<chatID - String>, <Limit - Integer>);
```
- Output:
```
...
```js
Levels.computeLeaderboard(<Client - telegraf.js Client>, <Leaderboard - fetchLeaderboard output>, <fetchUsers - boolean, disabled by default>);
```
- Output:
```
Promise<Array [Objects]>
