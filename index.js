...
class TelegramXp {
    ...
    * @param {string} [chatID] - Telegram Group id.
    */

    static async createUser(userId, chatID) {
        if (!userId) throw new TypeError("An user id was not provided.");
        if (!chatID) throw new TypeError("A group id was not provided.");

        const isUser = await levels.findOne({ userID: userId, chatID: chatID });
    ...
    */
    ...
    static async deleteUser(userId, chatID) {
        ...
        const user = await levels.findOne({ userID: userId, chatID: chatID });
        if (!user) return false;

        await levels.findOneAndDelete({ userID: userId, chatID: chatID }).catch(e => console.log(`Failed to delete user: ${e}`));
    ...
    */
    ...
    static async appendXp(userId, chatID, xp) {
        if (!userId) throw new TypeError("An user id was not provided.");
        if (!chatID) throw new TypeError("A group id was not provided.");
    ...
    */
    ...
    static async appendLevel(userId, chatID, levelss) {
        if (!userId) throw new TypeError("An user id was not provided.");
        if (!chatID) throw new TypeError("A group id was not provided.");
    ...
    */
    ...
    static async setXp(userId, chatID, xp) {
        if (!userId) throw new TypeError("An user id was not provided.");
        if (!chatID) throw new TypeError("A group id was not provided.");
        if (xp == 0 || !xp || isNaN(parseInt(xp))) throw new TypeError("An amount of xp was not provided/was invalid.");
    ...
    */
    ...
    static async setLevel(userId, chatID, level) {
        if (!userId) throw new TypeError("An user id was not provided.");
        if (!chatID) throw new TypeError("A group id was not provided.");
    ...
    */
    ...
    static async fetch(userId, chatID, fetchPosition = false) {
        if (!userId) throw new TypeError("An user id was not provided.");
        if (!chatID) throw new TypeError("A group id was not provided.");
    ...
    */
    ...
    static async subtractXp(userId, chatID, xp) {
        if (!userId) throw new TypeError("An user id was not provided.");
        if (!chatID) throw new TypeError("A group id was not provided.");
        if (xp == 0 || !xp || isNaN(parseInt(xp))) throw new TypeError("An amount of xp was not provided/was invalid.");
    ...
    */
    ...
    static async subtractLevel(userId, chatID, levelss) {
        if (!userId) throw new TypeError("An user id was not provided.");
        if (!chatID) throw new TypeError("A group id was not provided.");
        if (!levelss) throw new TypeError("An amount of levels was not provided.");
    ...
    */
    ...
    static async fetchLeaderboard(chatID, limit) {
        if (!chatID) throw new TypeError("A group id was not provided.");
        if (!limit) throw new TypeError("A limit was not provided.");

        var users = await levels.find({ chatID: chatID }).sort([['xp', 'descending']]).exec();

        return users.slice(0, limit);
    }

    /**
    * @param {string} [api] - Your telegram.api.
    * @param {array} [leaderboard] - The output from 'fetchLeaderboard' function.
    */

    static async computeLeaderboard(api, leaderboard, fetchUsers = false) {
        if (!api) throw new TypeError("A client was not provided.");
        ...
        if (fetchUsers) {
            for (const key of leaderboard) {
                const user = await api.getChat(key.userID) || { name: "Unknown" };
                computedArray.push({
                    chatID: key.chatID,
                    userID: key.userID,
                    xp: key.xp,
